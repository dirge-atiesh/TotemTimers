...
local L = LibStub("AceLocale-3.0"):NewLocale("TotemTimers", "esMX")
if not L then return end

L["Air Button"] = "Air Button" -- Requires localization
L["Cooldown"] = "Cooldown" -- Requires localization
L["Ctrl-Leftclick to remove weapon buffs"] = "Ctrl-Leftclick to remove weapon buffs" -- Requires localization
...
L["Rightclick to assign spell to leftclick"] = "Rightclick to assign spell to leftclick" -- Requires localization
L["Rightclick to assign totem to timer button"] = "Rightclick to assign totem to timer button" -- Requires localization
L["Rightclick to cast %s"] = "Rightclick to cast %s" -- Requires localization
...
L["Shift-Rightclick to assign spell to middleclick"] = "Shift-Rightclick to assign spell to middleclick" -- Requires localization
