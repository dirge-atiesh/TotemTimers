local L = LibStub("AceLocale-3.0"):NewLocale("TotemTimers_GUI", "ptBR")
...
L["Blizz Style"] = "Estilo da Blizzard" -- Needs review
L["Color Timer Bars"] = "Cor das barras de tempo" -- Needs review
L["Color Timer Bars according to their elements."] = "Cor das barras de tempo de acordo com seus elementos" -- Needs review
L["Debug"] = "Debug" -- Requires localization
L["Displays timer bars underneath times"] = "Mostrar barras abaixo dos temporizadores" -- Needs review
...
L["Time Font"] = "Fonte do tempo" -- Needs review
L["Timer Bar Color"] = "Cor da barra de tempo" -- Needs review
L["Timer Bar Texture"] = "Textura da barra de tempo" -- Needs review
...
L["Arrangement"] = "Arranjo" -- Needs review
L["Basic layout of the four timer buttons, loose lets you move them individually"] = "Organização básica dos quatro botões de tempo, soltos permitem ser movidos individualmente." -- Needs review
L["box"] = "box" -- Requires localization
L["Button Size"] = "Tamanho do botão" -- Needs review
...
L["Enables the four totem timer buttons and menus"] = "Ativar os quatro botões dos temporizadores dos totens e menus" -- Needs review
...
L["Timer Bar Position"] = "Posição da barra de temporização" -- Needs review
L["Timer Bar Position Desc"] = "Sets at which side of the timer icons the times are displayed" -- Requires localization
L["Timer Bar Width"] = "Largura da barra de tempo" -- Needs review
...
L["Time Size"] = "Tamanho do tempo (texto)" -- Needs review
L["Time Spacing"] = "Espaçamento do tempo (texto)" -- Needs review
L["Time Style"] = "Estilo do tempo" -- Needs review
